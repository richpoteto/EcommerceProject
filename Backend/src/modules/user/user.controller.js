 ...
 * @property {string} req.body.firstName - Author name of Product.
 * @property {string} req.body.lastName- The isbn of Product.
 * @property {string} req.body.password- The isbn of Product.
 * @returns {User}
 */
